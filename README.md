...
Within this repo, the following, primary components are included: 
- Several .txt files including the original data acquired from the previously listed online resource
- Modified data based on the IEEE-RTS-96 listed above in an .xlsx file
- Mathematical model encoded using Julia's JuMP, and a Julia script to solve the model therein using various solvers such as HiGHS and CPLEX
- Python script to generate figures for exploration of results acquired from the analysis of the computational model's solution and construction
